      ...
      <div className="flex items-center gap-2.5">
        ...
        >
          <svg width="16" height="16" viewBox="0 0 16 16" fill="none" aria-hidden="true">
            ...
            <path d="M5 2v3M11 2v3" stroke="white" strokeWidth="1.5" strokeLinecap="round" />
            <rect x="4.5" y="7.5" width="2.5" height="2" rx="0.5" fill="white" />
            <rect x="8.75" y="7.5" width="2.5" height="2" rx="0.5" fill="white" />
      ...
      <div className="flex items-center gap-2">
        ...
        >
          ...
          <div className="text-left">
            <p className="text-[12px] font-semibold leading-tight" style={{ color: '#1F2937' }}>
              State University
            </p>
          ...
          <svg width="14" height="14" viewBox="0 0 14 14" fill="none" aria-hidden="true">
            <path d="M3.5 5.5l3.5 3 3.5-3" stroke="#9CA3AF" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
        </button>
